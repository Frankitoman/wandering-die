...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      dice_dc_label: 'DC {dc}',
      dice_roll_result: 'Sacaste un {roll}',
      ...
      dice_custom_dc_detected: 'El destino detectó una dificultad de {dc} para esta decisión.',
    ...
    en: {
      ...
      dice_dc_label: 'DC {dc}',
      dice_roll_result: 'You rolled a {roll}',
      ...
      dice_custom_dc_detected: 'Fate detected a difficulty of {dc} for this decision.',
    ...
    da: {
      ...
      dice_rolling: 'Ruller...',
      dice_dc_label: 'DC {dc}',
      dice_roll_result: 'Du slog en {roll}',
      ...
      dice_custom_dc_detected: 'Skæbnen registrerede en sværhedsgrad på {dc} for denne beslutning.',
